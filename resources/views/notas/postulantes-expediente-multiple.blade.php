...
<head>
    ...
    <title>Reporte Final de Notas Registradas </title>
    <style>
        @page {
            margin: 0.9cm;
        }
...
<body>
    @foreach ($programasData as $index => $programaData)
        ...
        <div class="title-container">
            <h3 class="title">NOTAS DE CURRICULUM VITAE</h3>
        </div>
            ...
            <tbody>
                @foreach ($programaData['inscripciones'] as $inscripcion)
                    <tr>
                        ...
                        <td>{{ $inscripcion->nota->cv ?? 'Pendiente' }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
        ...
        <div class="firma-container">
            <div class="datos-docente">
                ...
                <p>DOCENTE EVALUADOR</p>
                <p><strong>DNI:</strong> {{ $programaData['docente']->dni ?? '' }}</p>
            </div>
        </div>

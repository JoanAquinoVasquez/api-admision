    ...
    <div class="email-wrapper">
        ...
        <div class="email-body">
            ...
            <div class="alert-card">
                <h3 class="alert-title">🚨 PLAZO LÍMITE Y CITACIÓN URGENTE</h3>
                <div class="alert-desc">
                    <p style="margin: 0 0 0.8rem 0;">
                        1. <strong>Plazo de Entrega de CV:</strong> Tiene plazo máximo e improrrogable para entregar su CV físico hasta el día <strong>Jueves</strong>.
                    </p>
                    <p style="margin: 0;">
                        2. <strong>Citación Obligatoria:</strong> Se le cita el día <strong>SÁBADO 04 DE JULIO a las 08:30 AM</strong> en las instalaciones de la <strong>Escuela de Posgrado</strong> para la culminación presencial de su trámite documentario correspondiente al proceso de Admisión 2026-I.
                    </p>
                </div>
            </div>

        ...
        <div class="email-body">
            ...
            <div class="req-box">
                ...
                <ul class="req-list">
                    ...
                    @if(isset($programa_id) && in_array($programa_id, [33, 34]) && isset($val_fisica) && $val_fisica == 0)
                        <li>Llevar su <strong>expediente y su currículum vitae documentado, foliado y anillado con tapa verde</strong>.</li>
                    @endif
                </ul>
            </div>

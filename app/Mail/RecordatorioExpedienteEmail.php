...
class RecordatorioExpedienteEmail extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'Urgente: Recordatorio de Presentación de Expediente Físico - EPG UNPRG',
        );
    }
    ...
    public function content(): Content
    {
        ...
        return new Content(
            view: 'email.recordatorio-expediente',
            with: [

...
class ProgramaInhabilitadoEmail extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'Comunicado Importante: Apertura de Programa Académico - Escuela de Posgrado UNPRG',
        );
    }
    ...
    {
        // Cargar las relaciones necesarias en caso de que el queue worker las deserialize sin ellas
        ...
        return new Content(
            view: 'email.programa-inhabilitado',
            with: [

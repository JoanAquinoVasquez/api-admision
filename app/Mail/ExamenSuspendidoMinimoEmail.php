...
class ExamenSuspendidoMinimoEmail extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'Comunicado Importante: Suspensión del Examen de Admisión - Escuela de Posgrado UNPRG',
        );
    }
    ...
    public function content(): Content
    {
        ...
        return new Content(
            view: 'email.examen-suspendido-minimo',
            with: [

...
class ReservaExport implements FromCollection, WithHeadings, WithStyles
{
    public function collection()
    {
        $inscripciones = Inscripcion::where('estado', 2)->get();
    ...
    public function headings(): array
    {
        ...
        $programaHeading = "LISTA DE POSTULANTES PARA RESERVA - " . $timeActual . " | ESCUELA DE POSGRADO - UNPRG - ADMISIÓN $periodo"; // Encabezado especial
        return [
